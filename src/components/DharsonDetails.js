            ...
            <div className='car-details-component'>
                ...
                <div className='car-details-card'>
                    <div className='car-details-img-container'>
                        <img src={dharson1} alt="logo" className='car-details-images' />
                    </div>
                    <div className='car-details-content-container'>
                        <h5 className='car-details-title' style={{ textAlign: "justify" }}>DHARSON</h5>
